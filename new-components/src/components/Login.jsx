 const LoginForm = () => {
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[#d4af37]  animate-gradient-x"></div>


      <div className="absolute inset-0 bg-black/30 backdrop-blur-sm"></div>

  
      <div className="relative z-10 w-full max-w-md bg-black rounded-2xl shadow-xl p-8 transition-shadow duration-300 hover:shadow-2xl">

        <h2 className="text-3xl font-bold text-center text-[#f59e0b]">Welcome Back</h2>
        ...
        <div className="flex justify-between items-center mt-5 text-sm">
          ...
          <a href="/signup" className="text-[#F59E0B] hover:underline">Create Account</a>
        </div>
      </div>
    </div>
  );
